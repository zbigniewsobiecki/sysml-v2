 ...
 */
export async function parseCommand(filePatterns: string[], options: ParseOptions): Promise<void> {
 ...
 */
function formatOutput(results: ParseOutput[], options: ParseOptions): string {
