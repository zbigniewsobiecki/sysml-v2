 ...
 */
export function parseMultiplicityBound(bound: string): number | null {
    if (bound === '*') {
        return UNBOUNDED;
    }
 ...
 */
export function isUnbounded(value: number): boolean {
 ...
 */
export function validateMultiplicityBounds(
