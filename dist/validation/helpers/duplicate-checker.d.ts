 ...
 */
export declare function findDuplicateNames(elements: AstNode[], getName?: (el: AstNode) => string | undefined): DuplicateCheckResult;
 ...
 */
export declare function reportDuplicates(result: DuplicateCheckResult, accept: ValidationAcceptor, options?: ReportDuplicatesOptions): void;
/**
 ...
 */
export declare function checkAndReportDuplicates(elements: AstNode[], accept: ValidationAcceptor, options?: ReportDuplicatesOptions & {
