 ...
 */
function extractInnerElements(elements) {
    const result = [];
...
export class SysMLValidator {
     ...
     */
    checkRootNamespace(root, accept) {
     ...
     */
    checkPartDefinition(def, accept) {
     ...
     */
    checkTypeBodyRule(bodyRule, accept) {
        const asPartDef = bodyRule;
        // Check for abstract part definition with no members
     ...
     */
    checkAttributeDefinition(_def, _accept) {
     ...
     */
    checkAttributeUsage(usage, accept) {
